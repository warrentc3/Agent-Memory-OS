...
- **Vector Retrieval:** candidate-provider integration remains validation-only unless activation gates approve production influence.
- **Temporal Memory:** hindsight-based chronological tracking.
- **Associative Layers:** graph/resonance-style recall remains roadmap / validation scope until backed by release evidence.
...
Canonical project state is maintained in:
