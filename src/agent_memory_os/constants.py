"""Shared AgentMemoryOS policy constants."""

from .sync_bundles import CURRENT_BUNDLE_VERSION, SUPPORTED_BUNDLE_VERSIONS

# Pairing
PAIRING_INVITE_TTL_SECONDS = 600
PAIRING_REDEEM_TIMEOUT_SECONDS = 15

# CLI network and subprocess waits
...
# CLI process freshness and restart handling
...
# Federation sync
SYNC_BUNDLE_VERSION = CURRENT_BUNDLE_VERSION
SYNC_SUPPORTED_BUNDLE_VERSIONS = SUPPORTED_BUNDLE_VERSIONS
...
WEB_LOG_TAIL_READ_BYTES = 2_000_000
...
# Unwired ERA resonance prototype
