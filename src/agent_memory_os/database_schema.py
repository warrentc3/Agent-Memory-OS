...
CREATE TABLE IF NOT EXISTS memories (
  ...
  decay_half_life_days REAL NOT NULL DEFAULT __AMOS_DEFAULT_DECAY_HALF_LIFE_DAYS__,
  last_accessed_at TEXT,
  access_count INTEGER NOT NULL DEFAULT 0,
  pinned INTEGER NOT NULL DEFAULT 0,
  RecVersion INTEGER NOT NULL DEFAULT 0
);
...
SCHEMA = SCHEMA.replace(
    "__AMOS_DEFAULT_DECAY_HALF_LIFE_DAYS__",
    format(DEFAULT_DECAY_HALF_LIFE_FALLBACK_DAYS, "g"),
)
