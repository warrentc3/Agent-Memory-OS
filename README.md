...
- **[Validation Plan](docs/VALIDATION_PLAN.md)** & **[latest validation report](docs/reports/20260710-v0.10.0-validation-report.md)** — gate matrix, reproducible harness (`scripts/validation_run.py`), measured results
